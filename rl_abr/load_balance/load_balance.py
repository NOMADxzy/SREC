...
from rl_abr.load_balance.job import Job

from rl_abr.load_balance.job import Job
from rl_abr.load_balance.job_generator import generate_job, generate_jobs
from rl_abr.load_balance.server import Server
    ...
    * REFERENCE *
    ...
    def generate_job(self):
        if self.num_stream_jobs_left > 0:
            dt, size = generate_job(self.np_random, self.job_size_pareto_shape, self.job_size_pareto_scale, self.job_interval)
