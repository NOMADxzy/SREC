    ...
    * REFERENCE *
    ...
    def __init__(self, seed=42, **kwargs):
        ...
        self.un_norm_observation_space = spaces.Box(self.src.min_values, \
                                            self.src.max_values, \
                                            dtype=np.float32)
        self.observation_space = self.un_norm_observation_space if not self.normalize else spaces.Box(0.0, 1.0, shape = self.un_norm_observation_space.shape, dtype=np.float32)
